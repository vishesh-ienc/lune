#!/usr/bin/env node
/**
 * test-option1-offscreen-arg.js
 *
 * OPTION 1: Off-screen window position via launch arguments.
 *
 * Appends `--window-position=-32000,-32000` to the Chromium/Electron spawn arguments.
 * Completely omits post-spawn HWND polling / hide hooks to test whether Chromium respects
 * off-screen launch coordinates from the very beginning (preventing any initial paint on real desktop).
 *
 * Performs full LSP verification:
 *   1. Spawn process with --window-position=-32000,-32000
 *   2. Poll for language_server_windows_x64.exe
 *   3. Extract CSRF token & listening ports
 *   4. Execute GetUserStatus query
 *   5. Cleanly terminate process tree
 */
...
async function runTest() {
  console.log(c(BO, '\n==============================================================='));
  console.log(c(BO, '  OPTION 1: OFF-SCREEN LAUNCH ARG TEST  (test-option1-offscreen-arg.js)'));
  console.log(c(BO, '===============================================================\n'));
